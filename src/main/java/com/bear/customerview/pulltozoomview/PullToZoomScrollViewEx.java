...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    private OnCustomScrollViewChangedListener onCustomScrollViewChangedListener;

    public void setOnCustomScrollViewChangedListener(OnCustomScrollViewChangedListener onCustomScrollViewChangedListener) {
        this.onCustomScrollViewChangedListener = onCustomScrollViewChangedListener;
    }
    ...
    public PullToZoomScrollViewEx(Context context, AttributeSet attrs) {
        ...
        ((InternalScrollView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
            ...
            public void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop) {
                if(null!=onCustomScrollViewChangedListener){
                    onCustomScrollViewChangedListener.onScrollChanged(left,top,oldLeft,oldTop);
                }
            ...
            public void onScreenStateChanged(int screenState) {
                if(null!=onCustomScrollViewChangedListener){
                    onCustomScrollViewChangedListener.onScreenStateChanged(screenState);
                }
            }
        });
    ...
    protected class InternalScrollView extends ScrollView {
        ...
        public void onScreenStateChanged(int screenState) {
            ...
            if(onCustomScrollViewChangedListener!=null){
                onScrollViewChangedListener.onScreenStateChanged(screenState);
            }
        }
