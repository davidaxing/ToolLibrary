...
public abstract class RecyclerViewHeaderAdapter<V extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<V> {
    public static final int INT_TYPE_HEADER = 2;
    public static final int INT_TYPE_FOOTER = 3;
    public static final int INT_TYPE_NORMAL = 4;
...
//		}
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (position >= headers.size()
                && (position - headers.size()) < getCount()
                && getItemViewType(position) == INT_TYPE_NORMAL) {
