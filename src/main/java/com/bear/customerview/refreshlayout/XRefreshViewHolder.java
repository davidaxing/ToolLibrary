...
import com.bear.customerview.drawable.RingProgressDrawable;
 ...
 */
public abstract class XRefreshViewHolder {
    /**
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected XRefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
...
//    protected AnimationDrawable mFooterChrysanthemumAd;
     ...
     */
    public XRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
...
//            }
            ...
            ringProgressDrawable = new RingProgressDrawable(mContext);
...
//            mFooterChrysanthemumAd = (AnimationDrawable) mFooterChrysanthemumIv.getDrawable();
            mFooterChrysanthemumIv.setBackground(ringProgressDrawable);
//            mFooterChrysanthemumIv.setImageResource(R.drawable.load_0);
            ringProgressDrawable.setPercent(100);
    ...
    public void changeToLoadingMore() {
        if (mIsLoadingMoreEnabled && ringProgressDrawable != null) {
