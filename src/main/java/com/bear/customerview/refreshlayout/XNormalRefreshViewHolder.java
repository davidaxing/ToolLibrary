 ...
 * 描述:类似新浪微博下拉刷新风格
 */
public class XNormalRefreshViewHolder extends XRefreshViewHolder {
    ...
    private String mSuccessRefreshText = "刷新成功";
    private String mReleaseRefreshText = "释放更新";
    private String mRefreshingText = "加载中...";
    private XRefreshLayoutScaleListener _mScaleListener;
    private int mHeight;
    /**下拉进度*/
     ...
     */
    public XNormalRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
...
//        mDownAnim.setFillAfter(true);
    ...
    public void setXRefreshLayoutScaleListener(XRefreshLayoutScaleListener _mScaleListener) {
        this._mScaleListener = _mScaleListener;
    }
    ...
    public View getRefreshHeaderView() {
        ...
        mHeight = mHeaderArrowIv.getLayoutParams().height;
        Log.i("tempHeight", mHeight + "");
    ...
    public void handleScale(float scale, int moveYDistance) {
        /**设置头部刷新监听回调**/
        if (_mScaleListener != null) {
            _mScaleListener.OnRefreshLayoutScaleChange(scale);
        }

//        int current = (int) (scale * mHeight);
//        AutoFrameLayout.LayoutParams params = new AutoFrameLayout.LayoutParams(current, current);
//        mHeaderArrowIv.setLayoutParams(params);
//        mHeaderArrowIv.setImageResource(R.drawable.load_0);
        //XRefreshScrollingUtil.setHeaderImg(mHeaderArrowIv, scale);
    }
...
//        mHeaderArrowIv.setVisibility(View.INVISIBLE);
        ...
        mHeaderArrowIv.setVisibility(View.INVISIBLE);
        if (mHeaderChrysanthemumIv.getVisibility() != View.VISIBLE || !mHeaderChrysanthemumAd.isRunning()) {
            mHeaderChrysanthemumAd.start();
            mHeaderChrysanthemumIv.setVisibility(View.VISIBLE);
            mHeaderStatusTv.setText(mPullDownRefreshText);
        }
